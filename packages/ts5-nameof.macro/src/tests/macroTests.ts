...
runCommonTests(run, { commonPrefix: "import nameof from './ts5-nameof.macro';\n" });

describe("using a name other than nameof", () => {
  it("should work when using a different import name", () => {
    const text = "import other from './ts5-nameof.macro';other(console.log);other.full(console.log);";
